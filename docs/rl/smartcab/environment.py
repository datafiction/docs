...
#
# 1. TrafficLight : reset,
#                   update
#
# 2. Environment : create_agent,
#                  set_primary_agent,
#                  reset,
#                  step,
#                  sense,
...
class Environment(object):
    ...
    def __init__(self, verbose=False, num_dummies=100, grid_size = (8, 6)):
        ...
        # 4. Create dummy agents
        for i in xrange(self.num_dummies):
            self.create_agent(DummyAgent)



        # 5. Primary agent and associated parameters
        ...
        # 6. Trial data (updated at the end of each trial)
        self.trial_data = {
